...
| Transaction grouping? | **TODO (Phase 6)** | Statement-level granularity misses transaction atomicity. Deferred as optimization. | See [13_phased_implementation.md#todo-transaction-grouping](13_phased_implementation.md#todo-transaction-grouping) |
